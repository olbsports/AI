      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('Erreur de chargement', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Theme.of(context).textTheme.bodyLarge?.color)),
            const SizedBox(height: 8),
            Text(error, style: TextStyle(color: Theme.of(context).textTheme.bodyMedium?.color), textAlign: TextAlign.center),
        ...
        children: [
          ...
          if (isMobile)
            Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text('Dashboard', style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: Theme.of(context).textTheme.bodyLarge?.color)),
                const SizedBox(height: 4),
                Text('Données en temps réel', style: TextStyle(color: Theme.of(context).textTheme.bodyMedium?.color, fontSize: 14)),
              ],
            )
          else
            Row(
              ...
              children: [
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text('Dashboard', style: TextStyle(fontSize: 28, fontWeight: FontWeight.bold, color: Theme.of(context).textTheme.bodyLarge?.color)),
                    Text('Données en temps réel de votre plateforme', style: TextStyle(color: Theme.of(context).textTheme.bodyMedium?.color)),
                  ],
                ),
                Row(
                  children: [
          ...
          Card(
            child: Padding(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text('Utilisateurs par abonnement', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600, color: Theme.of(context).textTheme.bodyLarge?.color)),
                  const SizedBox(height: 16),
                  if (usersByPlan.isEmpty)
                    Text('Aucune donnée disponible', style: TextStyle(color: Theme.of(context).textTheme.bodyMedium?.color))
                  else
                    ...usersByPlan.entries.map((e) => Padding(
                      ...
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          Text(_getPlanDisplayName(e.key), style: TextStyle(color: Theme.of(context).textTheme.bodyMedium?.color)),
                          Text(e.value.toString(), style: TextStyle(fontWeight: FontWeight.w600, color: Theme.of(context).textTheme.bodyLarge?.color)),
                        ],
                      ),
                    )),
                ],
          ...
          Card(
            child: Padding(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text('Actions rapides', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600, color: Theme.of(context).textTheme.bodyLarge?.color)),
                  const SizedBox(height: 16),
                  Wrap(
                    spacing: 12,
                    runSpacing: 12,
          ...
          children: [
            Builder(
              builder: (ctx) => Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  Text(title, style: TextStyle(color: Theme.of(ctx).textTheme.bodyMedium?.color, fontSize: 14)),
                  Container(
            ...
            Builder(
              builder: (ctx) => Text(value, style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: Theme.of(ctx).textTheme.bodyLarge?.color)),
            ),
            const SizedBox(height: 4),
            Builder(
              builder: (ctx) => Text(subtitle, style: TextStyle(color: Theme.of(ctx).textTheme.bodyMedium?.color, fontSize: 12)),
            ),
          ],
        ),
      ),
            ...
            Expanded(
              child: Builder(
                builder: (ctx) => Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text(title, style: TextStyle(color: Theme.of(ctx).textTheme.bodyMedium?.color, fontSize: 12)),
                    Text(value, style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Theme.of(ctx).textTheme.bodyLarge?.color)),
                    Text(subtitle, style: TextStyle(color: Theme.of(ctx).textTheme.bodyMedium?.color?.withOpacity(0.6), fontSize: 11)),
                  ],
                ),
              ),
            ),
