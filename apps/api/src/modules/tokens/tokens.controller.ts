...
export class TokensController {
  ...
  async debitTokens(@CurrentOrganization() organizationId: string, @Body() dto: DebitTokensDto) {
  ...
  async checkTokens(@CurrentOrganization() organizationId: string, @Body() dto: CheckTokensDto) {
  ...
  @ApiParam({
    name: 'serviceType',
    description: 'Service type (e.g., radiologySimple, videoAnalysis)',
  })
  ...
  async handleStripeWebhook(
    ...
    const event = stripe.webhooks.constructEvent(req.rawBody!, signature, stripeWebhookSecret);
